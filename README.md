This software consists of two parts, a DataHistorian (DH) and a web-based user interface (unidb).
...
More information like manuals, demo version or services at [MeierSoft.de](https://MeierSoft.de).
