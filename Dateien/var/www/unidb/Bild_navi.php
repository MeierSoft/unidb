...
if($anzeigen == 1) {
	if ($mobil==1){
		if($line["geloescht"] != 1) {echo "<td><a href='Bilder_bauen.php?Baum_ID=".$Baum_ID."&Server_ID=".$Server_ID."' target='_self'>".$Text[9]."</a>&nbsp;&nbsp;&nbsp;</td>";}
	} else {
		if($line["geloescht"] != 1) {echo "<td><a href='Bilder_bauen.php?Baum_ID=".$Baum_ID."&Server_ID=".$Server_ID."' target='Hauptrahmen'>".$Text[9]."</a>&nbsp;&nbsp;&nbsp;</td>";}
	}
