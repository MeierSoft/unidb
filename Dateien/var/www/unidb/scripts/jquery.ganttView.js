        ...
        function addVtHeader(div, data, cellHeight) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                for (var j = 0; j < data[i].series.length; j++) {
                    seriesDiv.append(jQuery("<div>", { "class": "ganttview-vtheader-series-name", "title": data[i].series[j].name })
        ...
        function addBlocks(div, data, cellWidth, start) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
					...
					var Hinweis = "";
					if (series.beschreibung != undefined) {Hinweis = series.beschreibung.replace( /(<([^>]+)>)/ig, '')};
					var block = jQuery("<div>", {
                        "class": "ganttview-block",
                        "title": Hinweis,
                        "onclick": "alert(" + String.fromCharCode(34) + Hinweis + String.fromCharCode(34) + ");",
                        "css": {
