...
<?php
	...
	echo '<div id="schaltfl_2" style="width: 34%;" onclick="umschalten(2);" class="schaltfl_mobil">'.$Text[28].'</div>';
...
<div class="bereich_mobil" name="Zeit_einstellen" id="zeit_einstellen">
	<table width="100%" style="padding-top: 5px;">
		<tr>
			<?php
				echo "<td>".$Text[9]."</td><td align='center'>".$Text[10]."</td><td>".$Text[29]."</td><td></td><td></td><td></td></tr>\n";
		...
		<tr>
			<td>
				<?php
					...
					echo "<tr><td><div class='slidecontainer'><input name = 'Pos_Regler' type='range' min='0' max='100' value='".$Pos_Regler."' class='slider' id='schieberegler' onclick='Regler_schieben();'></div></td></tr>\n";
				?>
			</td>
		</tr>
	</table>
...
<div class="bereich_mobil" align="center" name="Sonstiges" id="sonstiges">
	<table style="padding-top: 5px;" width="100%"><tr>
		...
		<?php
			...
			echo "<td><input class='Text_Element' name='Smax' value= '".$Smax."' type='text' size='4' maxlength='7'></td>";
			echo "<td><a href='./Tabelle.php?Tag_ID=".$Tag_ID."&akt=".$akt."&Start=".$Start."&Ende=".$Ende."&Tag=".$Tag."&Bezeichnung=".$Bezeichnung."&EUDESC=".$EUDESC."&Dezimalstellen=".$Dezimalstellen."&Breite=".$Breite."&Art=".$Art."&Bezeichnung=".$Bezeichnung."' target='_self'>".$Text[20]."</a></td>";
			echo "<td><input class='Schalter_Element' value='".$Text[17]."' type='submit' name='Aktion'></td><td><input value='1' type='checkbox' name='Legende' checked></td>";
		?>
		</tr>
	</table>
</div>