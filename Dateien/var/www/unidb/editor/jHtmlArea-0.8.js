...
(function ($, window) {
    ...
    jHtmlArea.fn = jHtmlArea.prototype = {
        ...
        increasefontsize: function () {
            if ($browser.msie === true) {
            	...
            	try {this.ec("fontSize", false, this.qc("fontSize") + 1);
            	} catch (err) {}
            }
        },
    ...
    jHtmlArea.defaultOptions = {
        ...
        css: null,
        toolbarText: {
            bold: "Bold", italic: "Italic", underline: "Underline", strikethrough: "Strike-Through", forecolor: "forecolor",
    ...
    var priv = {
        toolbarButtons: {
            forecolor: "forecolor", strikethrough: "strikeThrough", orderedlist: "orderedList", unorderedlist: "unorderedList",
